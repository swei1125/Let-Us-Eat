              ...
              <form onSubmit={this.handleSubmit.bind(this)} className="search_form2">
                ...
                <div className="where">
                  <div className="inputs">
                    <h2>Near</h2>
                  <input id="initialInput" required type="text" onChange={this.update.bind(this, "location")} value={this.state.location} placeholder="city, area, state or/and zip" onSubmit={this.handleSubmit.bind(this)}/>
                  </div>
